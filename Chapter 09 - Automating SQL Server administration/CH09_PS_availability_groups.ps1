...
# Setup: TODO Configure these
    ...
    $PrimaryReplicaInstanceName = "SQL2K19" #Named instance or DEFAULT for the default instance
    $SecondaryReplicaName1 = "SQLSERVER-1"
    $SecondaryReplicaInstanceName1 = "SQL2K19" #Named instance or DEFAULT for the default instance
    $AvailabilityGroupName = "WWI2019-AG"
