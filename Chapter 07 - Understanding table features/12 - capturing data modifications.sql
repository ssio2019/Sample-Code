...
ALTER DATABASE WideWorldImporters_modded
...
ALTER TABLE Sales.Orders
    ...
    -- and track which columns changedwere included in the statements
...
UPDATE Sales.Orders
	SET Comments = 'I am a new comment again'
	WHERE OrderID = 1;
...
SELECT *
    ...
    , CHANGE_TRACKING_IS_COLUMN_IN_MASK(@OrderCommentsColumnId, CT.SYS_CHANGE_COLUMNS) CommentsChanged
    -- Determine if the DeliveryInstructions column was included
    , CHANGE_TRACKING_IS_COLUMN_IN_MASK(@DeliveryInstructionsColumnId, CT.SYS_CHANGE_COLUMNS) DeliveryInstructionsChanged
